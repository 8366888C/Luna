...
Client-side React islands — JavaScript only loads when they become interactive. Includes a theme toggle with localStorage persistence, a 3D perspective tilt effect on hover, an image gallery carousel with keyboard and mouse wheel navigation, and category/tag filtering controls for both blog and portfolio.
