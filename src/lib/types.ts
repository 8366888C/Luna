...
export interface portfolioConfig {
  ...
  id: string;
  date: string;
  category: portfolioCategoryType; // robotics="Robotics & Mechanical Systems", software= "Software Tools & Web", gameplay= "Gameplay Engineering", analytics= "Business Intelligence & Analytics", ai= "Artificial Intelligence"
  title: string;
  tagline: string;
  description: string;
  keywords: string[];
