...
That one command sets up commitlint, Husky hooks, a `.releaserc` for semantic release, GitHub issue and PR templates, a code of conduct, a license, and a `.gitignore` - all configured and ready to go.
...
If you are tired of wiring up the same boilerplate for every project, or if your team's commit hygiene keeps slipping, give it a try.
